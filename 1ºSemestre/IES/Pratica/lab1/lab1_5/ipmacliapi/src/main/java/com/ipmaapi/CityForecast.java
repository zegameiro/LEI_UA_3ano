...
public class CityForecast {
    ...
    public String toString() {
        ...
        return "Today' Forecast:" +
               "\nPrecipitation Probability -> " + getPrecipitaProb() +
               "\nMin Temperature -> " + getTMin() +
               "\nMax Temperature -> " + getTMax() + 
               "\nPredicted Wind Direction -> " + getPredWindDir() +
               "\nWind Speed Class -> " + getClassWindSpeed();
